...
public class BettersSelector extends DeterministicSelector 
{
			...
			new Comparator<IIndividual> () 
	{
		public int compare(IIndividual arg0, IIndividual arg1) {
			int fitnessComparison = fitnessComparator.compare(arg0.getFitness(), arg1.getFitness());

			if(fitnessComparison == 0)
			{
				int arg0size = ((SyntaxTreeRuleIndividual) arg0).getGenotype().size();
				int arg1size = ((SyntaxTreeRuleIndividual) arg1).getGenotype().size();
